...
mail = music()
mail.get_hotcomments(target_url)                      
mail.get_allcomments(target_url)

# mail.get_allcomments("https://music.163.com/weapi/v1/resource/comments/R_SO_4_1406649619?csrf_token")
